...
import { input_types as app_input_types, output_types as app_output_types, shared_types as app_shared_types } from './app/types';
...
export function gen_app_endpoints(): [string, string] {
...
export function gen() {
    ...
    let [app_rust_endpoints, app_endpoint_param_types] = gen_app_endpoints();

    if (!fs.existsSync("./../../backend/api/src/generated")) fs.mkdirSync("./../../backend/api/src/generated");
    fs.writeFileSync('./../../backend/api/src/generated/app_types.rs', app_rust_types + "\n\n" + app_endpoint_param_types);
    fs.writeFileSync('./../../backend/api/src/generated/app_endpoints.rs', app_rust_endpoints);
